...
.studio-workspace { display: flex; flex-direction: column; background: #09090e; min-height: 0; }
...
.history-strip { flex: 0 0 auto; padding: 8px 16px 10px; overflow: hidden; border-top: 1px solid rgba(113, 113, 122, .2); background: #101017; }
.history-strip-title { display: flex; align-items: center; justify-content: space-between; margin-bottom: 2px; color: #d4d4d8; font-size: 12px; font-weight: 700; }
